...
import com.kimtien.vay.nhanh.tien.credit.cash.loan.utils.ContactHelp;
...
public class RiskDataUtils {
    ...
    public static JSONArray getSmsList(Context context) {
        JSONArray jsonArray = new JSONArray();
        if (PermissionUtils.checkPermission(context, Manifest.permission.READ_SMS)
                && PermissionUtils.checkPermission(context, Manifest.permission.READ_CONTACTS)) {
            ...
            while (cursor.moveToNext()) {
                ...
                String name = getName(phone, context);
                try {
    ...
    private static String getName(String address, Context context) {
        String phone = null;
    ...
    public static JSONArray getCellinfoList(Context context) {
        JSONArray jsonArray = new JSONArray();
